...
const ContactUs = () => {
    return (
        <>
            <h1 className='text-5xl font-bold text-center text-primary m-9 uppercase'> Customer Feedback</h1>
            <div style={{
                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    <div className="card-body">
                        <form className='flex flex-col '>
                            <h1 className='text-2xl text-primary font-semibold mb-3'>Have some question?</h1>
