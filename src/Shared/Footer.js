...
const Footer = () => {
    return (
        <footer className='bg-primary  w-full py-8 mt-8'>
            <div className='max-w-screen-xl mx-auto px-4'>
                <div className=' flex max-w-xs mx-auto items-center justify-between'>
                    <a
                        href='https://github.com/ShimulChandraDas'
                        className='text-gray-400 hover:text-white-800 transition-colors duration-200'
                    >
                        <svg
                            width='20'
                            height='20'
                ...
                <div className='text-center text-cyan-600 pt-10 sm:pt-12 font-light flex items-center justify-center'>
                    All Rights Reserved By &copy; MTB Bike Toolers | {year}
                </div>
            </div>
        </footer>
    );
